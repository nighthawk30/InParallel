...
public class Tile : MonoBehaviour
{
    ...
    void Wires()
    {
        if (Input.GetMouseButtonDown(0) && GetComponent<Hover>().HoverTest() && (red == null || blue == null))//clicked with wires and there are more available connections on this object - for now
        {
